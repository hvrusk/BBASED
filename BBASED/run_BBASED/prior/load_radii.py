...
with open('BBASED/run_BBASED/prior/rad_prior_files/WD_Rad_prior.pkl', 'rb') as f:
    WD_radius_prior = pickle.load(f)

with open('BBASED/run_BBASED/prior/rad_prior_files/MS_Rad_prior.pkl', 'rb') as f:
    MS_radius_prior = pickle.load(f)

with open('BBASED/run_BBASED/prior/rad_prior_files/MS_met_prior.pkl', 'rb') as f:
